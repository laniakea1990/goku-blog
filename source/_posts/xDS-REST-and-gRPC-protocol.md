...
![Version update after ACK](/images/xds/simple-ack.svg)
...
![No version update after NACK](/images/xds/simple-ack.svg)

Later, an API update may succeed at a new version __Y__:

![ACK after NACK](/images/xds/later-ack.svg)
...
![Multiple EDS requests on the same stream](/images/xds/eds-same-stream.svgg)
![Multiple EDS requests on distinct streams](/images/xds/eds-distinct-stream.svg)
...
![CDS response leads to EDS resource hint update](/images/xds/cds-eds-resources.svg)
...
![EDS update race motivates nonces](/images/xds/update-race.svg)
...
![Requests become stale](/images/xds/stale-requests.svg)
...
![EDS/CDS multiplexed on an ADS stream](/images/xds/ads.svg)
...
![Incremental session example](/images/xds/incremental.svg)
...
![Incremental reconnect example](/images/xds/incremental-reconnect.svg)
